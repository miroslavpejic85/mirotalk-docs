...
# Download the latest version of docker-compose (v5.4.0 in this case) for Linux (x86_64 architecture)
wget https://github.com/docker/compose/releases/download/v5.4.0/docker-compose-linux-x86_64
