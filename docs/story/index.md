---
title: The Story Behind MiroTalk
description: How a 2020 side project grew into an open-source family of WebRTC communication products.
---

<header class="editorial-hero story-hero">
	<span class="editorial-kicker">From one question to seven applications</span>
	...
	<div class="editorial-actions">
		...
		<a class="md-button story-visual-button" href="../sites/story.html">Open the visual story</a>
	</div>
...
<div class="story-marker" aria-hidden="true"></div>
...
<div class="principle-grid">
	<section><strong>Deployment choice</strong><p>Run the software on infrastructure you select and manage.</p></section>
	<section><strong>Operational control</strong><p>Define your own access, logging, retention, and network policies.</p></section>
	<section><strong>Inspectable architecture</strong><p>Review how signaling, media, authentication, and integrations are implemented.</p></section>
	<section><strong>Open-source development</strong><p>Learn from, test, and contribute to the public codebases.</p></section>
</div>

Self-hosting increases control, but privacy and security still depend on configuration, product architecture, infrastructure, integrations, and operating practices. The [technical overview](../overview/index.md) documents those boundaries.
...
- Group meetings through [MiroTalk SFU](../mirotalk-sfu/index.md)
- Private and small-group calls through [MiroTalk P2P](../mirotalk-p2p/index.md)
- Focused one-to-one calls through [MiroTalk C2C](../mirotalk-c2c/index.md)
- One-to-many broadcasts through [MiroTalk BRO](../mirotalk-bro/index.md)
- Click-to-call workflows through [MiroTalk CME](../mirotalk-cme/index.md)
- Accounts, rooms, and scheduling through [MiroTalk WEB](../mirotalk-web/index.md)
- Infrastructure administration through [MiroTalk ADMIN](../mirotalk-admin/index.md)

The [product chooser](../projects/index.md) explains where each product fits.
