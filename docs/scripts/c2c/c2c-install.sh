...
#---------------------------------------------
# MiroTalk C2C Install Script (Root)
#---------------------------------------------
...
\__|     \__|\__|\__|       \______/ \__| \_______|\__|\__|  \__|
      ...
      MiroTalk C2C Automated Install Script             
...
##---------------------------------------------
# Clone MiroTalk C2C repo
#---------------------------------------------

info "Cloning MiroTalk C2C repository..."
git clone https://github.com/miroslavpejic85/mirotalkc2c.git $PROJECT_DIR
cd $PROJECT_DIR
...
services:
    $PROJECT_NAME:
        ...
        volumes:
            ...
            - $PROJECT_DIR/frontend/:/src/frontend/:ro
            - $PROJECT_DIR/backend/:/src/backend/:ro
EOF
...
info "Configuring Nginx for MiroTalk C2C..."
...
info "MiroTalk C2C installation complete!"
