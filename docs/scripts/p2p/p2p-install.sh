...
#---------------------------------------------
# MiroTalk P2P Install Script (Root)
#---------------------------------------------
...
\__|     \__|\__|\__|       \______/ \__| \_______|\__|\__|  \__|
      ...
      MiroTalk P2P Automated Install Script             
...
info "Cloning MiroTalk P2P repository..."
git clone https://github.com/miroslavpejic85/mirotalk.git $PROJECT_DIR
cd $PROJECT_DIR
