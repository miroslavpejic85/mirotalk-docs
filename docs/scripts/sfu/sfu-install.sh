...
#---------------------------------------------
# MiroTalk SFU Install Script (Root)
#---------------------------------------------
...
info "Run all apt commands in non-interactive mode"
...
#---------------------------------------------
# Clone MiroTalk SFU repo
#---------------------------------------------

info "Cloning MiroTalk SFU repository..."
git clone https://github.com/miroslavpejic85/mirotalksfu.git $PROJECT_DIR
cd $PROJECT_DIR
...
info "Configuring Nginx for MiroTalk SFU..."
