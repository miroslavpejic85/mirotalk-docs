...
#---------------------------------------------
# MiroTalk WEB Uninstall Script (Root)
#---------------------------------------------
...
\__|     \__|\__|\__|       \______/ \__| \_______|\__|\__|  \__|
     ...
     MiroTalk WEB Automated Uninstall Script             
...
#---------------------------------------------
# Stop and remove MiroTalk Docker containers
#---------------------------------------------
...
if docker ps -a | grep -q mirotalkmongodb; then
    info "Stopping MongoDB container..."
    docker stop mirotalkmongodb
    info "Removing MongoDB container..."
    docker rm mirotalkmongodb
fi
...
if [ -d "$PROJECT_DIR/.mongodb_data" ]; then
    info "Removing MongoDB data..."
    rm -rf "$PROJECT_DIR/.mongodb_data"
fi
