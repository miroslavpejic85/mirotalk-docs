...
#---------------------------------------------
# MiroTalk CME Install Script (Root)
#---------------------------------------------
...
\__|     \__|\__|\__|       \______/ \__| \_______|\__|\__|  \__|
      ...
      MiroTalk CME Automated Install Script             
...
##---------------------------------------------
# Clone MiroTalk CME repo
#---------------------------------------------

info "Cloning MiroTalk CME repository..."
git clone https://github.com/miroslavpejic85/call-me.git $PROJECT_DIR
cd $PROJECT_DIR
...
info "Configuring Nginx for MiroTalk CME..."
