...
1. **[`config.js`](https://github.com/miroslavpejic85/call-me/blob/main/public/config.template.js)**  
...
2. **[`.env`](https://github.com/miroslavpejic85/call-me/blob/main/.env.template)**  
