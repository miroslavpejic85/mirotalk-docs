...
[`server.js`](https://github.com/miroslavpejic85/call-me/blob/main/webhook/server.js) is a tiny, dependency-free Node.js server that receives events, verifies the signature, and logs each one. Run it in parallel with `Call-Me` to watch events live:
