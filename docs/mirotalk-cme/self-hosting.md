...
!!! tip "Quick Automated Installation"
    ...
    You can automate the entire setup (Node.js, Nginx, SSL, Docker) using our installation scripts on a clean Ubuntu server. Check out the [MiroTalk CME Setup Script](https://docs.mirotalk.com/scripts/about/#mirotalk-cme) for details.
