...
A secure, modern web dashboard to manage **[MiroTalk](../overview/index.md)** updates, configuration, and settings with ease.
...
- The bundled certificate in `backend/ssl/` is **self-signed**
